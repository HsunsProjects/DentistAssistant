    ...
    public partial class DentistAssistantContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server=DESKTOP-R4Q0L8N\\HSUNSPROJECTS;Database=DentistAssistant;User Id=sa;Password=Eason0811;Trusted_Connection=True;Integrated Security=false;");
